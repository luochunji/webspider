...
public class TaskAction {
    ...
    @Deprecated
    public void pause(@RequestParam("taskId") Long taskId,PrintWriter printWriter){
        ...
        schedulerService.pauseTrigger(String.valueOf(taskId));
    ...
    @Deprecated
    public void resume(@RequestParam("taskId") Long taskId,PrintWriter printWriter){
        TaskScheduler taskScheduler = taskSchedulerService.find(taskId);
        taskScheduler.setTaskStatus(Constant.TASK_STATUS_RUNNING);
        taskSchedulerService.update(taskScheduler);
        schedulerService.resumeTrigger(String.valueOf(taskId));
        JSONObject json = new JSONObject();
        json.put("result","success");
    ...
    @Deprecated
    public String remove(@RequestParam("taskId") String taskId,ModelMap modelMap){
    ...
    @RequestMapping("/add")
    @Deprecated
    public String add(@ModelAttribute("taskForm") TaskBean taskBean) throws Exception{
        ...
        String cronExpression = getCronExpression(taskBean);
