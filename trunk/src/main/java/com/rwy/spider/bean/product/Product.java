...
//    private Set<ProductRule> rules = new HashSet<ProductRule>();
    ...
    public Product(Product product,ProductDetail detail) {
        ...
        this.md5Code = createId(itemId,price,category,type,validName,validDesc);
    }
    private String createId(String itemId,double price, String category, String type, String validName, String validDesc) {

        return MD5Utils.MD5Encode(itemId + price + category + type + validName + validDesc);
    }
