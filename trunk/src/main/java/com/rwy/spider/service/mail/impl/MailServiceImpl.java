...
public class MailServiceImpl {
    ...
    public void execute(TaskScheduler taskScheduler,Map map) throws MessagingException,IOException{
        ...
        try {
            ...
            //设置收件人
            helper.setTo(taskScheduler.getEmail());
            //设置主题
            ...
            templateMap.put("task",taskScheduler);
