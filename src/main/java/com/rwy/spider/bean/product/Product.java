...
public class Product implements Serializable{
    ...
    public Product(String productName, String itemId, double price) {
        this.productName = productName;
        this.itemId = itemId;
        this.price = price;
    }

    public Product(String itemId, String productName, String productUrl, String picUrl, String storeName, double price, String storeUrl) {
        this.itemId = itemId;
        this.productName = productName;
    ...
    public Product(Product product,ProductDetail detail) {
        ...
        this.storeUrl = product.getStoreUrl();
        this.category = detail.getCategory();
        this.type = detail.getType();
        this.validName = detail.getValidName();
        this.validDesc = detail.getValidDesc();
        this.orderStartDate = detail.getOrderStartDate();
        this.orderEndDate = detail.getOrderEndDate();
        this.validWeeks = detail.getValidWeeks();
        this.html = product.getHtml();
        this.md5Code = createId(itemId,skuId,price,category,type,validName,validDesc);
    }
    private String createId(String itemId,String skuId,double price, String category, String type, String validName, String validDesc) {

        return MD5Utils.MD5Encode(itemId + skuId + price + category + type + validName + validDesc);
    }
